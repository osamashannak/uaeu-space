...
const SearchBox = (props: { type: "professor" | "course", setState: any }) => {
        ...
        const {
            ...
            async onInputValueChange({inputValue}) {
                ...
                if (!allItems.length) {
                    ...
                    setItems(fuse.search(inputValue, {limit: 5}).map((result) => result.item));
            ...
            onSelectedItemChange: ({selectedItem: newSelectedItem}) => {
                ...
                if ('email' in newSelectedItem) {
                    props.setState(newSelectedItem.email);
                } else {
                    props.setState(newSelectedItem.tag);
                }
            }
        })
            ...
            <div className={styles.dashboardSearchBox}>
                ...
                <div className={styles.parentDataList}>
                    <ul className={styles.datalist}
                        style={{backgroundColor: props.type === "course" ? "#ADFFFD" : "#FAFAFA"}} {...getMenuProps()}>
                        {inputValue &&
