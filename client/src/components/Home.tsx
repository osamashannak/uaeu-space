...
const onChangeProf = (e: ChangeEvent<HTMLInputElement>): void => {
    const text = e.target.value;

    // TODO search for course here (autocomplete)
}

const onProfSelect = (event, value) => {
                    ...
                    <div className="box box2">
                        ...
                        <div className="search">
                            ...
                            <Autocomplete
                                ...
                                onChange={onProfSelect}
                                renderInput={params => <TextField {...params} label="Search professor name" />}
                                options={[]}
                            />
                            {/*<input className="unselectable search-bar" onChange={onChangeProf} type="text" placeholder="Search professor name"/>*/}
                        </div>
                    </div>
                </div>
